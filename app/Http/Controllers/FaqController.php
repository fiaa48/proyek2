...
class FaqController extends Controller
{
    public function index()
    {
        $faqs = [
            ...
            ['question' => 'Techfix Kita Menerima Service apa saja?', 'answer' => 'Kami menerima service Laptop, komputer, dan printer baik hardware, software maupun elektronik lainnya.'],
